...
def load_weights(
    ...
    if adapter_lora_path != "":
        ...
        domain_lora_state_dict = (
            ...
            if "state_dict" in domain_lora_state_dict
            else domain_lora_state_dict
        )
        domain_lora_state_dict.pop("animatediff_config", "")

        animation_pipeline = load_diffusers_lora(
            animation_pipeline, domain_lora_state_dict, alpha=adapter_lora_scale
        )
